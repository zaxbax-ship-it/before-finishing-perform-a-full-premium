...
export const ENVIRONMENT_SPECS: EnvironmentVariableSpec[] = [
  ...
  { name: 'LEMON_SQUEEZY_API_KEY', visibility: 'server', description: 'Lemon Squeezy server API key.' },
  ...
  { name: 'NEXT_PUBLIC_SENTRY_TRACES_SAMPLE_RATE', visibility: 'public', description: 'Optional trace sample rate between 0 and 1.' },
