...
const resources: LocaleResources = {
  ...
  "ui": {
    ...
    "reuseHint": "שימוש ראשון חינם. שימוש שני עולה 25% מהקופה הנוכחית, עם דיאלוג אישור. שימוש שלישי אינו אפשרי.",
  ...
  "uiExt": {
    ...
    "rule4": "כל גלגל הצלה חינם בפעם הראשונה. שימוש שני עולה 25% מהקופה הנוכחית ומצריך אישור, ואין שימוש שלישי.",
